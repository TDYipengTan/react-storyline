...
describe("<Heading />", () => {
  ...
  it("renders a Heading with a specific align", async () => {
    const { getByText } = render(<Heading level="1" textAlign="start">Heading</Heading>);

    const { style } = getByText("Heading");
  ...
  it("renders with an animated skeleton", () => {
    ...
    expect(getByText("Heading").classList).toContain(
      "co-heading--animated-skeleton"
    );
  });

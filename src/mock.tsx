...
export const EmailChannelMockData: (EmailItemProps & { id: string })[] = [
  {
    id: getRandomId(),
    fromSrc: user1,
    toSrc: user2,
...
export const ChatChannelMockData: (ChatItemProps & { id: string })[] = Array.from(
  new Array(3),
  () => [
    {
      id: getRandomId(),
...
export const SMSChannelMockData: (SMSItemProps & { id: string })[] = [
  {
    id: getRandomId(),
    src: user4,
    content: (
...
export const VoiceChannelMockData = Array.from(new Array(10), () => [
  {
    id: getRandomId(),
    src: user7,
    content: (
